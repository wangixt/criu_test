...
clean-npu_plugin:
	$(Q) $(MAKE) -C plugins/npu clean
.PHONY: clean-npu_plugin
...
clean: clean-top clean-amdgpu_plugin clean-npu_plugin

mrproper-top: clean-top clean-amdgpu_plugin clean-npu_plugin
	$(Q) $(RM) $(CONFIG_HEADER)
	$(Q) $(RM) $(VERSION_HEADER)
...
help:
	...
	@echo '      npu_plugin      - Make NPU plugin'
.PHONY: help
